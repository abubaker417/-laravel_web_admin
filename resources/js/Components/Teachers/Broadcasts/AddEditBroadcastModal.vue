            ...
            <div class="modal-body">
                <div class="row">
                        ...
                        <div :class="{'show active': secondIndex == 0}" class="tab-pane fade mb-2" :id="`nav-${lang.code}`" role="tabpanel" :aria-labelledby="`nav-${lang.code}-tab`">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input v-model="form.name[lang.code]"
                                    class="w-100 rounded-3 form-control px-3"
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <Multiselect v-model="form.tag_ids" valueProp="id" label="name" mode="tags" class="rounded-3" :close-on-select="false" :searchable="false"
                    ...
                    <div class="col-md-6">
                        ...
                        <div v-if="form.link_type =='internal' && form.file_type == 'audio'" class="form-group mb-3 mt-2">
                            ...
                            <input id="teacher-audio" @change="onBroadcastFileChange($event,'audio')" type="file" />
                        ...
                        <div v-if="form.link_type =='internal' && form.file_type == 'video'" class="form-group mb-3 mt-2">
                            ...
                            <input id="teacher-video" @change="onBroadcastFileChange($event,'video')" type="file" />
                ...
                <!-- <div class="form-group mb-3">
                    ...
                    <!-- Cropped image previewer -->
                        ...
                        <img v-if="croppedImageSrc" style="width:120px ; height: 120px" class="mx-auto m-2 bg-light rounded-4" :src="croppedImageSrc" />
                </div>
...
export default defineComponent({
    ...
    methods:{
        ...
        create(){
            this.form.post(this.route('teachers.teacher_broadcasts.store'), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
        ...
        update(){
            this.form.transform((data) => ({
                    ...data,
                    _method: "PUT",
                })).post(this.route('teachers.teacher_broadcasts.update',{teacher_broadcast:this.modalData.id}), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
