    ...
    return {
      form: this.$inertia.form({
        settings: [{
          ...
          'value': this.$page.props.teacher.teacher_settings['facebook_url'] ?? "",
        },
        {
          'name': 'twitter/X_url',
          'display_name': "Twitter/X Url",
          'image_url':"twitter.png",
          'value': this.$page.props.teacher.teacher_settings['twitter_url'] ?? "",
        },
        {
          'name': 'youtube_url',
          'display_name': "Youtube Url",
          'image_url':"youtube.png",
          'value': this.$page.props.teacher.teacher_settings['youtube_url'] ?? "",
        },
        {
          'name': 'tiktok_url',
          'display_name': "TikTok Url",
          'image_url':"tiktok.png",
          'value': this.$page.props.teacher.teacher_settings['tiktok_url'] ?? "",
        },
        {
          'name': 'linkedin_url',
          'display_name': "LinkedIn Url",
          'image_url':"linkedin.png",
          'value': this.$page.props.teacher.teacher_settings['linkedin_url'] ?? "",
        },
        {
          'name': 'whatsapp_url',
          'display_name': "Whatsapp Url",
          'image_url':"whatsapp.png",
          'value': this.$page.props.teacher.teacher_settings['whatsapp_url'] ?? "",
        },
        {
          'name': 'snapchat_url',
          'display_name': "Snapchat Url",
          'image_url':"snapchat.png",
          'value': this.$page.props.teacher.teacher_settings['snapchat_url'] ?? "",
        },
        {
          'name': 'instagram_url',
          'display_name': "Instagram Url",
          'image_url':"instagram.png",
          'value': this.$page.props.teacher.teacher_settings['instagram_url'] ?? "",
        },
        {
          'name': 'pinterest_url',
          'display_name': "PinTerest Url",
          'image_url':"pinterest.png",
          'value': this.$page.props.teacher.teacher_settings['pinterest_url'] ?? "",
        }
        ]
      }),
    };
  ...
  methods: {
    submit() {
      this.form
        ...
        .post(this.route("teachers.update_settings"), {
            onSuccess: () => {
                         this.goToNextTab()
                    }
        });
