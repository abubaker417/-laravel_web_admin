<template>
    ...
    <div class="container" v-if="fetching">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div v-if="currentTab === index">
                                        ...
                                        <teacher-appointment-list-card
                                            :appointments="appointments"></teacher-appointment-list-card>
                                        <div class="col-12">
      ...
      <div class="container py-4">
        <teacher-appointment-list-card :appointments="appointments">
        </teacher-appointment-list-card>
        <div class="col-12">
          <TablePagination
...
import TeacherAppointmentListCard from "@/Components/Teachers/AppointmentLogs/TeacherAppointmentListCard.vue";
...
export default defineComponent({
  ...
  methods: {
    ...
    getAppointmentFilterData(loading_more) {
      this.fetching = true;
      axios
        .post(this.route("getApiTeacherFilterAppointmentLogs"), this.filter)
        .then((res) => {
